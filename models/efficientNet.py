...
class MBConv(nn.Module):
    def __init__(self, inplanes, planes, repeat, kernel_size, stride, expand, se_ratio, sum_layer, count_layer=None,
                 pl=0.5):
...
def efficientnet_b0(num_classes=1000):
    return EfficientNet(num_classes=num_classes, width_coef=1.0, depth_coef=1.0, scale=1.0, dropout_ratio=0.2,
                        se_ratio=0.25)


def efficientnet_b1(num_classes=1000):
    return EfficientNet(num_classes=num_classes, width_coef=1.0, depth_coef=1.1, scale=240 / 224, dropout_ratio=0.2,
                        se_ratio=0.25)


def efficientnet_b2(num_classes=1000):
    return EfficientNet(num_classes=num_classes, width_coef=1.1, depth_coef=1.2, scale=260 / 224., dropout_ratio=0.3,
                        se_ratio=0.25)


def efficientnet_b3(num_classes=1000):
    return EfficientNet(num_classes=num_classes, width_coef=1.2, depth_coef=1.4, scale=300 / 224, dropout_ratio=0.3,
                        se_ratio=0.25)


def efficientnet_b4(num_classes=1000):
    return EfficientNet(num_classes=num_classes, width_coef=1.4, depth_coef=1.8, scale=380 / 224, dropout_ratio=0.4,
                        se_ratio=0.25)


def efficientnet_b5(num_classes=1000):
    return EfficientNet(num_classes=num_classes, width_coef=1.6, depth_coef=2.2, scale=456 / 224, dropout_ratio=0.4,
                        se_ratio=0.25)


def efficientnet_b6(num_classes=1000):
    return EfficientNet(num_classes=num_classes, width_coef=1.8, depth_coef=2.6, scale=528 / 224, dropout_ratio=0.5,
                        se_ratio=0.25)


def efficientnet_b7(num_classes=1000):
    return EfficientNet(num_classes=num_classes, width_coef=2.0, depth_coef=3.1, scale=600 / 224, dropout_ratio=0.5,
                        se_ratio=0.25)
